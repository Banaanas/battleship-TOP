...
describe("gameboardTest.receiveAttack method", () => {
  it("determines whether or not the attack hit a ship", () => {
    gameboardTest.receiveAttack(95); // 1 damage
    ...
    gameboardTest.receiveAttack(75); // 1 missed shot
    ...
    gameboardTest.receiveAttack(4); // 1 damage
    ...
    gameboardTest.receiveAttack(72); // 1 damage
    ...
    gameboardTest.receiveAttack(96); // 1 damage
    ...
    gameboardTest.receiveAttack(35); // 1 missed shot
    gameboardTest.receiveAttack(62); // 1 missed shot
    gameboardTest.receiveAttack(18); // 1 missed shot
    gameboardTest.receiveAttack(86); // 1 missed shot
    expect(gameboardTest.missedShots.length).toBe(5); // No missed shots
    expect(gameboardTest.missedShots).toEqual([75, 35, 62, 18, 86]); // No missed shots
  });
});
